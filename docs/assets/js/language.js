let deContent = new Map([
    ...
    ['lading-page-content-a', 'Schau dir den Code an<img src="assets/github_logo.svg" alt="Github logo">'],
    ['app-introduction-p', 'Die HelpMyCar Driver App ermöglicht es Fahrern eines vernetzten Autos unkompliziert eine Panne zu melden und begleitet sie anschließend durch den Hilfsprozess.<br>Die folgenden Bilder zeigen einen typischen Pannenhilfeprozess:'],
    ['app-content-figcaption-1', 'Nachdem der Nutzer sich angemeldet hat, kann er die von Ihm registrierten Fahrzeuge sehen.<br><br>Er erhält einen Überblick über die Panne und kann sich dieses Fahrzeug in einer detaillierten Ansicht ansehen.<br><br>Mit dem Button am unteren Ende des Bildschirms kann er eine Hilfsanfrage senden.'],
    ['app-content-figcaption-2', 'In der Detailansicht erkennt man welches Fahrzeugteil einen Fehler meldet. Darunter sieht man die Warnleuchten des Fahrzeugs mit einer kurzen Beschreibung.<br><br>Weiterhin erhält man zusätzliche allgemeine Informationen über das Fahrzeug.'],
    ['app-content-figcaption-3', 'Im Hauptschritt des Pannenhilfeprozess wird der Nutzer durch die vier verschiedenen Status des Prozesses geleitet:<br><br><ol><li>Anfrage wird bearbeitet</li><li>Fehler werden analysiert</li><li>Service-Fahrzeug ist unterwegs, mit der voraussichtlichen Ankunftszeit</li><li>Mechaniker ist angekommen und behebt das Problem</li></ol>'],
    ...
    ['dashboard-content-description-middle', 'In der Mitte des Dashboards ist die detaillierte Übersicht der Kunden- und Fahrzeuginformationen zu erkennen. Anhand des drehbaren Automodells, in dem die fehlerhaften Bereiche des Autos markiert werden, können die vorhandenen Probleme schnell erkannt und analysiert werden. Die eingebundene Karte zeigt das Auto des Kunden und alle verfügbaren Service-Fahrzeuge mit ihrer Position an. So kann der Assistance Operator schnell einen Überblick über die einsatzbereiten Service-Fahrzeuge und deren Entfernung zum Kunden erlangen.'],
    ['dashboard-content-description-right', 'Die Elemente auf der rechten Seite des Dashboards zeigen die vom Fahrzeug gesendeten Diagnostic Trouble Codes und deren Beschreibung sowie den Warnleuchtenstatus. Sobald der Assistance Operator das Problem analysiert hat, kann er den passenden Abschleppwagen oder ein On-site Service-Fahrzeug aus der Liste auswählen und entsenden. Sollte der Kunde oder der Assistance Operator weitere Fragen haben, können diese über den Chat am rechten unteren Rand geklärt werden.'],
    ...
    ['architecture-content-text-p', 'Mit Hilfe eines Browsers können die Endnutzer des HelpMyCar-Systems auf die App und das Dashboard zugreifen, welche als Angular Apps implementiert sind.<br><br>Die Angular Apps kommunizieren über HTTP mit dem Spring Boot Backend, welches über die Caruso Dataplace API Informationen zu den vernetzten Fahrzeugen abfragt und anschließend dem Frontend bereitstellt.<br><br> Die Zusatzfunktion, die Fahrzeuge auf dem Dashboard auf einer Karte anzuzeigen, wird mithilfe der GoogleMaps-API ermöglicht.<br><br>'],
...
let enContent = new Map([
    ...
    ['process-nav', 'Process'],
    ['lading-page-content-p', 'The HelpMyCar system helps drivers with a connected car to report breakdowns to a roadside assistance company quickly and easily. Employees of this company can view the breakdown reports on a dashboard. The data transmitted by the connected car is retrieved via the Caruso Dataplace and then displayed and visualized on the dashboard. The employee is shown the company\'s currently available service vehicles. With the help of this information, the employee can decide how to help the customer most quickly.'],
    ['lading-page-content-a', 'Look at the code<img src="assets/github_logo.svg" alt="Github logo">'],
    ['app-introduction-p', 'The HelpMyCar Driver App enables drivers of connected cars to easily report a breakdown of their car and then accompanies them through the roadside assistance process.<br>The following pictures show a typical roadside assistance process:'],
    ['app-content-figcaption-1', 'After the user has logged in, he can see the in the HelpMyCar system registered vehicles.<br><br>He can get a overview of the breakdown of his car and can have a look at each vehicle in a detailed view.<br><br>With the button at the bottom of the screen he can send a help request.'],
    ['app-content-figcaption-2', 'In the detailed view you can see which part of the vehicle reports an error. Below you can see the check control signs of the vehicle with a short description.<br><br>Furthermore you get additional general information about your vehicle.'],
    ...
    ['dashboard-introduction-p', 'The Assistance Operator Dashboard enables an employee of the roadside assistance company to comfortably and efficiently process breakdown reports from drivers. The employee gets an overview of all incoming help requests and their status. If one selects one of the help requests to process them, a detailed overview of the customer and vehicle information appears, which enables a quick problem analysis.<br> The dashboard is divided into three columns, which are explained in more detail using the following picture:'],
    ...
    ['architecture-content-text-p', 'With the help of a browser the end users of the HelpMyCar system can access the app and the dashboard, which are implemented as Angular Apps. <br><br>The Angular Apps retrieve the information requested by users via HTTP from the Spring Boot Backend, which queries information from connected vehicles via the Caruso Dataplace API and provides it to the frontend.<br><br> The additional function of seeing the vehicles on the dashboard on a map is enabled by the GoogleMaps API.<br><br>'],
...
// for a element to be able to be translated the translation must be provided in the content maps ('deContant' and 'enContent')
